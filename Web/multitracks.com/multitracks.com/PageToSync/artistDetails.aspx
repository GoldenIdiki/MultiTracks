			...
			<div class="wrapper mod-standard mod-gray">
				...
				<nav class="discovery--nav">
					<ul class="discovery--nav--list tab-filter--list u-no-scrollbar">
						...
						<li class="discovery--nav--list--item tab-filter--item">
							<a class="tab-filter" href="song.aspx" runat="server" id="songsPage">Songs</a>
						</li>
						<li class="discovery--nav--list--item tab-filter--item">
							<a class="tab-filter" href="album.aspx" runat="server" id="albumsPage">Albums</a>
						</li>
				...
				<div class="discovery--container u-container">
							<main class="discovery--section">
								<%foreach (var item in GetArtistDetails())
								{%>
									...
									<ul id="playlist" class="song-list mod-new mod-menu">
										<li class="song-list--item media-player--row">
											...
											<div class="song-list--item--player-img media-player">
												...
												src="<%= item.ArtistImageURL %>" alt="an image of <%= item.SongTitle %> by <%= item.ArtistName %>">
											</div>

											<div class="song-list--item--right">

												<a href="#" class="song-list--item--primary"><%= item.SongTitle %></a>
												<a class="song-list--item--secondary"><%= item.AlbumTitle %></a>
												<a class="song-list--item--secondary"><%= item.SongBpm %> BPM</a>
												<a class="song-list--item--secondary"><%= item.SongTimeSignature %></a>
											...
											<div class="ly-grid ly-grid-cranberries">
												...
												<div class="media-item">
													<a class="media-item--img--link" href="#" tabindex="0">
														<img class="media-item--img" alt="<% = item.AlbumTitle %>" src="<% =item.AlbumImageURL %>" srcset="<% =item.AlbumImageURL %>"/>
														<span class="image-tag">Master</span>
													</a>
													<a class="media-item--title" href="#" tabindex="0"><% = item.AlbumTitle %></a>
													<a class="media-item--subtitle" href="#" tabindex="0"><% = item.ArtistName %></a>
												</div>
											</div><!-- /.grid -->
