<%@ Page Language="C#" AutoEventWireup="true" CodeFile="album.aspx.cs" Inherits="PageToSync_album" %>
      ...
      <div class="mt-3">
          <div class="col-md-6 mx-auto">
            <nav class="nav justify-content-around">
              ...
              <a href="song.aspx" runat="server" id="songPage" class="btn btn-outline-secondary nav-item">Songs</a>
              <a href="#" class="btn btn-outline-secondary nav-item">Album</a>
